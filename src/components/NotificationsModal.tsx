    ...
    <>
      ...
      {/* Popup positioned relative to trigger */}
        ...
        <div className="max-h-96 overflow-auto">
          {/* Demo notification */}
          <div className="p-4 border-b border-zinc-800/50 hover:bg-zinc-900/30 transition-colors">
            <div className="flex items-start gap-3">
              {/* Notification icon */}
              <div 
                className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"
                style={{ backgroundColor: '#2fe3ac20' }}
              >
                <div 
                  className="w-2 h-2 rounded-full"
                  style={{ backgroundColor: '#2fe3ac' }}
                ></div>
              </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-zinc-400 text-xs leading-relaxed mb-1">
                  Your trade for 2.5x multiplier has been executed.
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-xs font-medium" style={{ color: '#2fe3ac' }}>
                    Profit: +$150.00
                  </span>
              ...
              {/* Close button */}
              <button 
                className="w-6 h-6 rounded hover:bg-zinc-800/50 flex items-center justify-center transition-colors flex-shrink-0"
