  ...
  if (isDev) {
    ...
    response.headers.set(
      ...
      [
        ...
        "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://vercel.live https://s3.tradingview.com https://*.tradingview.com",
        "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.tradingview.com",
        "img-src 'self' data: https: blob:",
        "font-src 'self' data: https://fonts.gstatic.com",
        "frame-src 'self' https://*.tradingview.com",
        `connect-src ${connectSrcDirective} https://*.tradingview.com`,
    ...
    response.headers.set(
      ...
      [
        "default-src 'self'",
        "script-src 'self' 'unsafe-inline' https://vercel.live https://s3.tradingview.com https://*.tradingview.com",
        "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.tradingview.com",
        "img-src 'self' data: https: blob:",
        "font-src 'self' data: https://fonts.gstatic.com",
        "frame-src 'self' https://*.tradingview.com",
